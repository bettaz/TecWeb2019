...
CREATE DATABASE IF NOT EXISTS `abettare` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `abettare`;
...
CREATE TABLE IF NOT EXISTS `defunti` (
  `cf` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL PRIMARY KEY,
  ...
  CONSTRAINT `auto`
    ...
    ON UPDATE CASCADE,
  CONSTRAINT `bare`
    FOREIGN KEY (`idBara`) REFERENCES `bare` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `urne`
    FOREIGN KEY (`idUrna`) REFERENCES `urne` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `composizioni`
    FOREIGN KEY (`idFiori`) REFERENCES `composizioni` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `cerimonie`
    FOREIGN KEY (`idCerimonia`) REFERENCES `cerimonie` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
('BTTLSS91H02A459X', 'Alessio', 'Bettarello', '1991-06-02', '2020-06-20', 'Padova', 'Mattia', 'Gottardello', '3098754671', '2020-07-12 09:41:22', 1, 2, 1, 2, 1, '10022.00', 1),
...
('DNOBRN57H22A469X', 'SDFFDS', 'ASDFSDA', '1212-12-12', '2020-11-13', 'asd 12 - asd (AO)', 'asd', 'asd', '123456789', '2020-08-11 13:31:58', 1, 1, 1, 4, 0, NULL, 1);
